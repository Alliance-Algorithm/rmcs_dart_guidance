...
//     struct Harness {
//         explicit Harness(bool require_lifting_down)
//             : task(
...
//                   trigger_lock_enable, 0.15, 0.0195, 10.0, 5.0, 1.5, 400, 2.0, 5.0, 0.15, 60,
//                   5000, require_lifting_down, lifting_command, lifting_left_vel_fb,
//                   lifting_right_vel_fb, belt_zero_calibration, yaw_pitch_control_velocity,
//                   aim_ready, aim_error_px, desired_target_px_output, target_position,
//                   target_tracking,
...
//         double belt_torque_offset{0.0};
//         double left_belt_angle{0.0};
//         double right_belt_angle{0.0};
...
//         bool belt_zero_calibration{false};
