...
public:
    VisionAssistedLaunchPreparationTask(
        ...
        bool& belt_zero_calibration, Eigen::Vector2d& yaw_pitch_control_velocity,
        bool& aim_ready, Eigen::Vector2d& aim_error_px, Eigen::Vector2d& desired_target_px_output,
        const cv::Point2i& target_position, const bool& target_tracking,
        const rclcpp::Logger& logger, AutoAimParams auto_aim_params)
        ...
        then(
            std::make_shared<LaunchPreparationTask>(
                ...
                down_ramp_timeout_ticks, require_lifting_down, lifting_command,
                lifting_left_vel_fb, lifting_right_vel_fb, belt_zero_calibration));
    }
};
