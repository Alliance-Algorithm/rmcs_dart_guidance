...
public:
    DartLaunchPrepareTask(
        ...
        then(
            std::make_shared<YawIssueCommandAction>(
                "yaw_vision_aim_begin", resources.yaw, YawCommand::VISION_AIM,
        ...
        then(
            std::make_shared<YawIssueCommandAction>(
                "yaw_vision_aim_end", resources.yaw, YawCommand::IDLE));
    }
